 ...
 */
contract MyToken is Context, ERC20, ERC20Permit, ERC20Burnable, Ownable2Step {

    uint256 public immutable MAX_TOTAL_SUPPLY = {{TOTAL_SUPPLY}} * 10 ** 18; // Max supply capped at 100 million tokens.
    uint256 public totalMinted; // Total amount of tokens that have been minted.
    uint256 public constant initialMint = {{INITIAL_MINT}} * 10 ** 18; // Initial amount of tokens minted to the deployer.
    ...
    ) ERC20("{{TOKEN_NAME}}", "{{TOKEN_SYMBOL}}") Ownable(initialOwner) ERC20Permit("CADAICO") {
